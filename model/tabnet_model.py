...
class TabNetPretraining(torch.nn.Module):
    def __init__(
        ...
        self.embedder = EmbeddingGenerator(input_dim,
                                           ...
                                           cat_idxs,
                                           cat_emb_dim,
                                           group_attention_matrix).to(self.device)
        ...
        self.Linear = Linear(self.input_dim, latent_dim, bias=False).to(self.device)
...
# tarencoder = TabNetPretraining(input_dim=X_train.shape[1],group_attention_matrix=create_group_matrix([], X_train.shape[1]).to('cuda:0'))
# print(tarencoder)
