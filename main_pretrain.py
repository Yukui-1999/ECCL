...
def get_args_parser():
    ...
    parser.add_argument('--Vit_embbeding',default=768,type=int,help='Vit_embbeding')
    ...
    parser.add_argument('--cmr_pretrained_model',default="/mnt/data/dingzhengyao/work/checkpoint/preject_version1/cmr_pretrain_output_dir/2002/checkpoint-17-auc-0.77.pth",type=str, metavar='MODEL', help='path of pretaained model')
    ...
    parser.add_argument('--output_dir', default='/mnt/data2/dingzhengyao/work/checkpoint/preject_version1/output_dir',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='/mnt/data2/dingzhengyao/work/checkpoint/preject_version1/log_dir',
...
def main(args):
    ...
    model = Trimodal_clip(global_pool=args.ecg_globle_pool, device=device, tar_number=args.tar_number, args=args)
    model.to(device)
    # print(model)
    ...
    if args.cmr_frooze:
        for name, param in model.CMR_encoder.named_parameters():
